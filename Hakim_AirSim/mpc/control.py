...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--x_ref", type=float, help="radius of the orbit", default=10)
    arg_parser.add_argument("--y_ref", type=float, help="altitude of orbit (in positive meters)", default=20)
    arg_parser.add_argument("--z_ref", type=float, help="speed of orbit (in meters/second)", default=3)
